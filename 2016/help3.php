<html><!-- InstanceBegin template="/Templates/banner.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<h1 class="header">Peer Evaluation Help</h1>
<!-- InstanceEndEditable -->
...
<div>
  ...
  <p><a href="/canvas/demos/Student Notification/index.html" target="media">Student Notification</a></p>
  <p><a href="/canvas/demos/Student View/" target="media">Student View</a></p>
  <p><a href="/canvas/demos/Summary Evaluations/" target="media">Summary Evaluations</a> (instructor approved)</p>
  <p><a href="/canvas/demos/Wrap-up/" target="media">Wrapping Up</a></p>
...
$(document).ready(function(e) {
	if(window.self == window.top)$("h1.header").show();
