<?php
//die($_REQUEST['custom_canvas_api_domain']);
...
include '/www/canvas/all_purpose.php';
...
function loadCategory(cat){
	$("#canvasgroups").load("<?php echo $_SESSION['peerhtml'] ?>getgroups.php", "catid=" + cat,function(response){
