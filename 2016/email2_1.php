...
$from = $_SESSION['cas_data']['USER'] . "@udel.edu";
	...
	include $_SESSION['peerphp'] . "timeout.php";
	die();
  }
...
$headers = "From:" . $fullname . " via: apps.ats.udel.edu <" . $_POST['from'] . ">\r\n";
...
</p><form name="notifygroup" method="post" action="<?php echo $_SESSION['../peer/peerhtml'] ?>email2_1.php" target="frame">
...
<p> From: <?php echo $_REQUEST['from'] ?></p>
    <p>
